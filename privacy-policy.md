...
- The right to lodge a complaint with your local Data Protection Authority. EU authorities are listed at [edpb.europa.eu](https://edpb.europa.eu). UK users may contact the ICO at [ico.org.uk](https://ico.org.uk).
...
- You may lodge a complaint with the Israeli Privacy Protection Authority (PPA), Ministry of Justice — [gov.il/en/departments/the_privacy_protection_authority](https://www.gov.il/en/departments/the_privacy_protection_authority).
...
We retain most of your data for as long as your account is active. As an exception, four kinds of history are deleted automatically on a rolling schedule based on your subscription tier, even while your account stays active: your workout logs, your cardio-session logs, your rivals (battle) history, and your Steps-Expedition logs. Each such record is stamped with an expiry date when it is created, and is then pruned automatically by our database once that date passes. On the **Free** tier, all four are kept for about 1 week; on the **Pro** tier, all four are kept for 1 year; on the **Max** tier they are kept for as long as your account exists. This automatic clean-up removes only old history entries — it does not affect your account, your Gymals, their stats, your personal records, streaks, or lifetime totals.
