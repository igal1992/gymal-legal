...
By creating an account or using the Gymal application (the "App"), you agree to be bound by these Terms of Service (the "Terms") and our [Privacy Policy](privacy-policy.html). If you do not agree, do not use the App. You must be at least 13 years of age to create an account. If you are under 18, you represent that your parent or legal guardian has reviewed and agreed to these Terms on your behalf.
...
- (a) the visual appearance, art style, sprite sheets, frame animations, color schemes, models, illustrations, and overall design of any Gymal character, monster, evolution stage, exclusive skin, theme, background, ornament, icon, or other in-App visual asset, including assets you have unlocked or purchased;
- (b) sound effects, music, voice clips, and any other audio assets;
- (c) monster statistics, abilities, type matchups, experience-point curves, levelling rates, battle mechanics, power calculations, drop rates, and reward formulas;
- (d) shop catalog, pricing, availability, exchange rates, seasonal events, and any in-game economy parameter;
- (e) workout generation logic, exercise content, achievement criteria, and challenge criteria; and
- (f) any user-interface element, navigation flow, or feature set.
...
- (a) Use offensive, hateful, or inappropriate display names or monster nicknames;
- (b) Harass, bully, or threaten other users through the friend or battle systems;
- (c) Exploit bugs, glitches, or vulnerabilities in the App;
- (d) Use automated tools, bots, or scripts to interact with the App;
- (e) Attempt to access another user's account;
- (f) Reverse engineer, decompile, or modify the App; or
- (g) Use the App for any illegal purpose.
...
- (a) any amount you paid for Coins, virtual items, exclusive skins, themes, monster slots, expansion slots, boosts, or any other one-time in-app purchase;
- (b) any amount charged to you under any auto-renewing subscription, including charges incurred after you stopped using the App, uninstalled the App, deleted your account, or lost access to your account, where you failed to cancel the subscription through the applicable platform store;
- (c) any loss, removal, redesign, replacement, or modification of any visual or audio asset, monster, skin, theme, item, or feature, including assets you previously purchased or unlocked;
- (d) any loss of, damage to, or unauthorized access to your account, including loss of progress, items, Coins, subscription benefits, or any other account data resulting in whole or in part from your failure to safeguard your credentials, from acts of any third party (including hackers), or from any account deletion, whether by you, by us, or by a third party;
- (e) any inability to access the App, loss of service, data loss, or service interruption; and
- (f) any loss of profits, goodwill, or anticipated benefit.
...
- (a) any amount you paid or were charged for any in-app purchase, Coin pack, virtual item, exclusive skin, theme, monster slot, boost, or other one-time purchase;
- (b) any amount you paid or were charged for any auto-renewing subscription, including charges that accrued because you did not cancel the subscription through Google Play or the Apple App Store before its next renewal date, or charges that continued after you stopped using or uninstalled the App or after your account was deleted; or
- (c) any change, redesign, replacement, or removal of any visual or audio asset, monster appearance, skin, theme, or feature that you previously unlocked or purchased.
...
For questions about these Terms, please use the in-app feedback feature or email **[gymonzapp@gmail.com](mailto:gymonzapp@gmail.com)**.
...
**Scope and duration.** This license is granted for the duration of your account plus the periods specified in Section 10 of the [Privacy Policy](privacy-policy.html) for any retained categories (e.g., feedback, bug reports, moderation reports). It does not authorize us to sell or sublicense your User Content to advertisers, data brokers, or any third party for marketing purposes.
...
8. **Developer Name and Contact.** The developers responsible for the App are **Igal Mekonen** and **Yuval Shamis**, Israel. Contact: [gymonzapp@gmail.com](mailto:gymonzapp@gmail.com).
